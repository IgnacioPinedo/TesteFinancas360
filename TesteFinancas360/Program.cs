...
namespace TesteFinancas360
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("preposicoes texto A: " + prepTextoA.Count());

            Console.WriteLine();

            Console.WriteLine("preposicoes texto B: " + prepTextoB.Count());
            ...
            List<string> vocaTextoA = new List<string>();

            vocaTextoA = palavrasTextoA.Distinct().ToList();

            vocaTextoA = vocaTextoA.OrderBy(i => ordemKlingon.IndexOf(i[0]))
                                   .ThenBy(i => ordemKlingon.IndexOf(i[1]))
                                   .ThenBy(i => ordemKlingon.IndexOf(i[2])).ToList();

            List<string> vocaTextoB = new List<string>();

            vocaTextoB = palavrasTextoB.Distinct().ToList();

            vocaTextoB = vocaTextoB.OrderBy(i => ordemKlingon.IndexOf(i[0]))
                                   .ThenBy(i => ordemKlingon.IndexOf(i[1]))
                                   .ThenBy(i => ordemKlingon.IndexOf(i[2])).ToList();

            Console.Write("Vocabulario Texto A: ");
            
            foreach (var palavra in vocaTextoA) 
            {
            ...
            Console.Write("Vocabulario Texto B: ");

            foreach (var palavra in vocaTextoB)
            {
                Console.Write(palavra + " ");
            }
